...
RSpec.describe 'Foods', type: :request do
  ...
  let(:food) { Food.create(name: 'apple', quantity: 2, measurement_unit: 'kg', price: 4, user_id: user.id) }
  ...
  describe 'GET /index' do
    ...
    it 'render contain foods' do
      @food1 = Food.create(name: 'apple', quantity: 2, measurement_unit: 'kg', price: 4, user_id: user.id)
      get foods_url
