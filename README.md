...
<img src = 'https://github.com/microverseinc/curriculum-rails/raw/main/recipe-app/images/recipe_erd_2_members.png'>
...
```sh
 git clone https://github.com/gauravgangwarweb/recipe_app.git
```
